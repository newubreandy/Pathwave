...
ROWS = [
    ...
    ('Admin', '운영', '직원 모니터링', '', '', '직원 모니터링',
     ...
     '직원 활동 로그 placeholder (백엔드 API 미구현)',
     'StaffMonitor.jsx (120줄)',
     '백엔드 /api/admin/staff/reports 미구현. UI 자리만'),
    ('Admin', '운영', '채팅 모니터링', '', '', '채팅 모니터링',
     'A-010', '',
     True, False, False, False, False, False, True, 30,
     '신고된 채팅방 placeholder (백엔드 API 미구현)',
     'ChatMonitor.jsx (120줄)',
     '/api/chat/reports 어드민 조회 엔드포인트 미구현'),
    ...
    ('Admin', '결제·정책', '쿠폰 통계', '', '', '쿠폰 통계', 'A-015', '',
     True, False, False, False, False, False, True, 40,
     '쿠폰 발급/사용/만료 카드 (백엔드 API 미구현 — placeholder)',
     'CouponStats.jsx (118줄)',
     '/api/admin/coupons 엔드포인트 추가 필요 (목록 + 집계)'),
